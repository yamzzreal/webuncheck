...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await sql`INSERT INTO inbox_keys(key_value,plan,expires_at) VALUES(${key},'free',${expires.toISOString()})`;
    return json(res, 200, {
      success:true,
      key,
      plan:"free",
    ...
    return json(res, 500, {success:false,message:"Gagal membuat key free",error:e.message});
  }
};
